  ...
  <div class="min-h-screen bg-alpha-surface pb-16 relative">
    ...
    <div class="relative z-10">
      ...
      <div class="px-4 py-6">
        ...
        <!-- 索赔界面 -->
        <div v-else-if="showClaimInterface && stakingDetail" class="rounded-2xl p-4 mb-6" style="background: linear-gradient(135deg, rgba(124, 221, 61, 0.8) 0%, rgba(83, 203, 67, 0.8) 100%)">
          <!-- 顶部按钮组 -->
            ...
            >
                ...
                <div class="relative z-10">
                  <div class="flex items-center justify-between mb-2">
                    <p class="text-gray-300 text-sm font-medium flex items-center">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1.5" :style="`color: ${stake.poolColor}`" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <!-- 收益图标 -->
                    <div class="flex items-center">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 animate-pulse" :style="`color: ${stake.poolColor}`" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div class="grid grid-cols-3 gap-3 mb-4">
                ...
                <div class="bg-alpha-surface rounded-lg p-3 border border-gray-600">
                  ...
                  <p class="text-white font-bold text-base">{{ new Date(stake.stakeStartTime * 1000).toLocaleDateString() }}</p>
                </div>
              </div>
        ...
        <!-- 质押详情界面 -->
        <div v-else-if="stakingDetail" class="rounded-2xl p-4 mb-6" style="background: linear-gradient(135deg, rgba(124, 221, 61, 0.8) 0%, rgba(83, 203, 67, 0.8) 100%)">
          ...
          <!-- 质押金额卡片 -->
          <div class="bg-alpha-surface-light bg-opacity-90 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-700 mb-4">
            <!-- 质押金额标题和图标 -->
            <div class="flex items-center justify-between mb-4">
              <div class="flex items-center">
                <!-- 池子等级图标 -->
          ...
          <div class="space-y-3 mb-4">
            ...
            <div class="grid grid-cols-2 gap-3">
              <div class="bg-alpha-surface-light bg-opacity-90 rounded-lg p-4 border border-gray-700">
                ...
                <p class="text-white font-bold text-base break-all">{{ formatNumber(stakingDetail?.totalStaked || '0') }}</p>
              </div>
              <div class="bg-alpha-surface-light bg-opacity-90 rounded-lg p-4 border border-gray-700">
                <p class="text-gray-400 text-sm mb-1">{{ t('staking.total_capacity') }}</p>
                <p class="text-white font-bold text-base break-all">{{ formatNumber(stakingDetail?.maxStakeAmount || '0') }}</p>
              </div>
            </div>

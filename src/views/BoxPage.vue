    ...
    <div class="px-4 py-6 relative flex flex-col min-h-[calc(100vh-140px)] justify-end">
      ...
      <footer class="flex justify-between items-center text-gray-500 text-xs absolute bottom-0 left-0 right-0 px-4 mb-4">
        ...
        <div class="flex gap-4">
          ...
          >
            <svg v-if="link.icon === 'twitter'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <svg v-if="link.icon === 'github'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <svg v-if="link.icon === 'telegram'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">

        ...
        <div class="rounded-2xl p-4 mb-6" style="background: linear-gradient(135deg, rgba(124, 221, 61, 0.8) 0%, rgba(83, 203, 67, 0.8) 100%)">
          ...
          <button class="btn-primary w-full mb-6 py-4 text-black font-bold text-lg rounded-full flex items-center justify-center">
            ...
            <div class="ml-2 bg-white bg-opacity-30 rounded-full px-2 py-1">
              <span class="text-black text-sm font-bold">{{ nftStakingList.length }}{{ t('staking.cards_count') }}</span>
            </div>
          </button>
            ...
            >
              ...
              <div class="flex items-center justify-between mb-4">
                ...
                <div class="flex items-center text-left">
                  ...
                  <div>
                    <div class="flex items-center">
                      <h3 class="text-lg font-bold text-white mr-2">{{ t(`staking.${nft.level === '金卡' ? 'gold' : nft.level === '银卡' ? 'silver' : 'bronze'}_card`) }}</h3>
                    </div>
                  ...
                  <div class="relative z-10">
                    <div class="flex items-center justify-between mb-2">
                      <p class="text-gray-300 text-sm font-medium flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1.5" :style="`color: ${nft.levelColor}`" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <!-- 趋势图标 -->
                      <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 animate-bounce" :style="`color: ${nft.levelColor}`" fill="none" viewBox="0 0 24 24" stroke="currentColor">
